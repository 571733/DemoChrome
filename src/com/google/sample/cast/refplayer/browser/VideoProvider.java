...
public class VideoProvider {
    ...
    public static List<MediaItem> buildMedia(String url) throws JSONException {
        ...
        if (null != categories) {
            ...
            Log.i("Kategori", ""+categories.length());
                ...
                String subsTitle [] = {"Ingrid sin favorittfilm", "Jørn sin favorittfilm", "Denne filmen holder meg oppe om natten. Må sees"};
                int p = 0;
                if (null != videos) {
                    for (int j = 3; j < 6; j++) {
